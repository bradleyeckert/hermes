...
uint8_t my_keys[] = {
  ...
  0x57,0x33,0x16,0x15,0xC7,0xE6,0xEE,0x54,0x9D,0x9E,0x27,0x52,0xDF,0xA6,0x1F,0x47};
...
const uint8_t new_keys[] = {
  ...
  0xF1,0x80,0x28,0x6B,0x74,0x63,0x65,0x1F,0x2F,0xCD,0x7C,0xF5,0xC5,0x58,0x59,0x5B};
